    ...
    <main className="min-h-screen">
        ...
        <div className="space-y-6">
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Tiger BioSciences Announces FDA Approval for Advanced Dermal Regeneration Matrix</h3>
          ...
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Strategic Partnership with Global Healthcare Network to Expand Access</h3>
              <p className="text-lead text-muted-foreground mb-4">
          ...
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Groundbreaking Study Published in Nature Medicine</h3>
              <p className="text-lead text-muted-foreground mb-4">
          ...
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Tiger BioSciences Receives Medical Innovation Excellence Award</h3>
              <p className="text-lead text-muted-foreground mb-4">
          ...
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Expansion of Manufacturing Capabilities Announced</h3>
              <p className="text-lead text-muted-foreground mb-4">
          ...
          <Card>
            <CardBody>
              ...
              <h3 className="text-h2 mb-3">Phase III Clinical Trial Results Exceed Primary Endpoints</h3>
              <p className="text-lead text-muted-foreground mb-4">
      ...
      >
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card>
            <CardBody>
              <h3 className="text-h2 mb-3 text-brand">Press Kit</h3>
          ...
          <Card>
            <CardBody>
              <h3 className="text-h2 mb-3 text-brand">Media Contact</h3>
              <p className="font-body text-muted-foreground mb-4">
          ...
          <Card>
            <CardBody>
              <h3 className="text-h2 mb-3 text-brand">Newsletter</h3>
              <p className="font-body text-muted-foreground mb-4">
